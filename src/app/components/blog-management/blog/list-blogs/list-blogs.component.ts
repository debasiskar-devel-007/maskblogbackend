...
export class ListBlogsComponent implements OnInit {
  ...
  constructor(public meta: MetaService, public activatedRoute:ActivatedRoute,public cookieService:CookieService) {
    ...
    this.meta.setTag('og:title', 'Virus Barrier Medical Face Mask Blog backend | Blog Listing');
    this.meta.setTag('twitter:title', 'Virus Barrier Medical Face Mask Blog backend | Blog Listing');
